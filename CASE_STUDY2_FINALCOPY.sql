/* FINAL CASE STUDY 2 CODE */ 
-- Create donations by month, averagee donation and sum of donations for June
...
EXEC totaldonationavgsum 'Vancouver', 6
 ...
 -- Average and sum of donations by postal code and city in a specific month; USING DATEPART FUNCTION FOR MONTH
CREATE PROCEDURE GetDonationStatisticsByCityAndMonth
    @city VARCHAR(100),
    @month INT
AS
BEGIN
...
EXEC GetDonationStatisticsByCityAndMonth @city = 'Vancouver', @month = 6;
